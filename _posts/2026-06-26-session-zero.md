...
I have only attempted to play solo rpg one other time, using the Ironsworn: Starforged system. I enjoyed it, but I have also found myself wanting to be able to use the Cortex Prime system. I haven't been able to use the system more than a few one shot, so I'll use it and add several tools:
